...
import org.example.notificationservice.kafka.order.Product;
...
import static org.example.notificationservice.email.EmailTemplates.ORDER_CONFIRMATION;
import static org.example.notificationservice.email.EmailTemplates.PAYMENT_CONFIRMATION;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(String destinationEmail,String customerName, BigDecimal amount, String orderReference) throws MessagingException {
        ...
        messageHelper.setFrom("titkov1993@bk.ru");
